   @csrf
        <div class="form-group">
            ...
            <input type="text" name="Cin" value="{{ $client->Cin ?? old('Cin') }}"  id="Cin" class="form-control" placeholder="Tapez un Cin">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nom"  value="{{  $client->nom ?? old('nom') }}"  id="nom"  class="form-control" placeholder="Tapez un Nom">
