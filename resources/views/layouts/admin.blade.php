...
<div class="container-fluid">
  <div class="row">
        ...
        <strong>Boutique</strong>
          ...
          <li class="nav-item">
            <a class="nav-link" href="/produits">
              <span data-feather="shopping-cart" class="fas fa-tshirt" ></span>
              Produits
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/commandes">
              <span data-feather="bar-chart-2"   class="fas fa-shopping-cart"></span>
        Commande
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/detailcommande">
              <span data-feather="layers"  class="fas fa-shopping-basket"></span>
          Détails Commandes
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">
              <span data-feather="layers" class="fas fa-money-check-alt"></span>
         Paiement
            </a>
          </li>
        </ul>
    ...
    <main role="main" class="col-md-9 ms-sm-auto col-lg-10 px-md-4 p-3">
@yield('main')
    </main>
